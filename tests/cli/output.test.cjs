...
test('output.installResult handles partial installations', () => {
  const result = output.installResult({
    updated: [{ name: 'Claude Desktop', path: '/path1' }, { name: 'VSCode', path: '/path2' }],
    total: 4,
...
test('output installResult handles various input combinations', () => {
  ...
  const result2 = output.installResult({ updated: [{ name: 'T1', path: 'P1' }, { name: 'T2', path: 'P2' }, { name: 'T3', path: 'P3' }, { name: 'T4', path: 'P4' }], total: 4, errors: [], notFound: [] });
  const result3 = output.installResult({ updated: [{ name: 'T1', path: 'P1' }, { name: 'T2', path: 'P2' }], total: 4, errors: [{ name: 'E1', message: 'Error' }], notFound: ['T'] });
