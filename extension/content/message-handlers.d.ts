 ...
 */
import type { ContentMessage, ContentPingResponse, WebSocketCaptureMode, HighlightResponse, WaterfallEntry, StateAction, BrowserStateSnapshot } from '../types';
...
export declare function handleExecuteJs(params: {
    script?: string;
    timeout_ms?: number;
}, sendResponse: (result: any) => void): boolean;
/**
 * Handle GASOLINE_EXECUTE_QUERY message
 */
export declare function handleExecuteQuery(params: string | Record<string, unknown>, sendResponse: (result: any) => void): boolean;
/**
 * Handle A11Y_QUERY message
 */
export declare function handleA11yQuery(params: string | Record<string, unknown>, sendResponse: (result: any) => void): boolean;
/**
 * Handle DOM_QUERY message
 */
export declare function handleDomQuery(params: string | Record<string, unknown>, sendResponse: (result: any) => void): boolean;
/**
