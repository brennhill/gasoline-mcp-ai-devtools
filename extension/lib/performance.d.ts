 ...
 */
export declare function getPerformanceMarks(options?: { since?: number }): Array<
  Omit<PerformanceMark, 'entryType'> & {
    detail?: unknown | null
  }
>
/**
 ...
 */
export declare function getCapturedMarks(): Array<
  PerformanceMark & {
    detail?: unknown
    capturedAt: string
  }
 ...
 */
export declare function getCapturedMeasures(): Array<
  PerformanceMeasure & {
    capturedAt: string
  }
>
 ...
 */
export declare function getPerformanceSnapshotForError(errorEntry: { ts?: string }): Promise<PerformanceSnapshot | null>
/**
