 ...
 */
export declare function sendLogsToServer(
  serverUrl: string,
  entries: LogEntry[],
 ...
 */
export declare function sendWSEventsToServer(
  serverUrl: string,
 ...
 */
export declare function sendNetworkBodiesToServer(
  serverUrl: string,
 ...
 */
export declare function sendNetworkWaterfallToServer(
  serverUrl: string,
  payload: {
 ...
 */
export declare function sendEnhancedActionsToServer(
  serverUrl: string,
 ...
 */
export declare function sendPerformanceSnapshotsToServer(
  serverUrl: string,
 ...
 */
export declare function postQueryResult(
  serverUrl: string,
  queryId: string,
  type: string,
  result: unknown,
 ...
 */
export declare function postAsyncCommandResult(
  serverUrl: string,
 ...
 */
export declare function postExtensionLogs(
  serverUrl: string,
  logs: Array<{
    timestamp: string
    level: string
 ...
 */
export declare function sendStatusPing(
  serverUrl: string,
  statusMessage: {
    type: string
 ...
 */
export declare function pollPendingQueries(
  serverUrl: string,
  sessionId: string,
  pilotState: '0' | '1',
  diagnosticLogFn?: (message: string) => void,
