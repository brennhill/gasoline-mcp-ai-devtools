 ...
 */
export declare function findOriginalLocation(
 ...
 */
export declare function fetchSourceMap(
  scriptUrl: string,
 ...
 */
export declare function resolveStackFrame(
 ...
 */
export declare function resolveStackTrace(
  stack: string,
  debugLogFn?: (category: string, message: string, data?: unknown) => void,
): Promise<string>
/**
 ...
 */
export declare function cleanupStaleProcessingQueries(
  debugLogFn?: (category: string, message: string, data?: unknown) => void,
): void
export {}
