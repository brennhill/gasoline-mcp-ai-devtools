 ...
 */
export declare function startQueryPolling(pollFn: () => Promise<void>, debugLogFn?: (category: string, message: string, data?: unknown) => void): void;
/**
 ...
 */
export declare function startSettingsHeartbeat(postSettingsFn: () => Promise<void>, debugLogFn?: (category: string, message: string, data?: unknown) => void): void;
/**
 * Stop settings heartbeat
 */
export declare function stopSettingsHeartbeat(debugLogFn?: (category: string, message: string, data?: unknown) => void): void;
/**
 ...
 */
export declare function startWaterfallPosting(postWaterfallFn: () => Promise<void>, debugLogFn?: (category: string, message: string, data?: unknown) => void): void;
/**
 * Stop network waterfall posting
 */
export declare function stopWaterfallPosting(debugLogFn?: (category: string, message: string, data?: unknown) => void): void;
/**
