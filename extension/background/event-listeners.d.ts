 ...
 */
export declare function handleTrackedTabUrlChange(
  updatedTabId: number,
  newUrl: string,
 ...
 */
export declare function handleTrackedTabClosed(
  closedTabId: number,
 ...
 */
export declare function forwardToAllContentScripts(
  message: {
    type: string
    [key: string]: unknown
  },
 ...
 */
export declare function loadSavedSettings(
  callback: (settings: {
    serverUrl?: string
    logLevel?: string
 ...
 */
export declare function loadAiWebPilotState(
...
export declare function getTrackedTabInfo(
...
export declare function getAllConfigSettings(
