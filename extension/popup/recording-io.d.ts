...
export declare function showMicPermissionPrompt(saveInfoEl: HTMLElement, audioMode: string): void;
export declare function sendRecordStart(els: RecordingElements, state: RecordingState, audioMode: string, showRecording: ShowRecordingFn, showIdle: ShowIdleFn, showStartError: ShowStartErrorFn): void;
export declare function tryMicPermissionThenStart(els: RecordingElements, state: RecordingState, audioMode: string, showRecording: ShowRecordingFn, showIdle: ShowIdleFn, showStartError: ShowStartErrorFn): void;
