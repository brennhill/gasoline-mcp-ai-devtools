...
Run `configure` with `what: "health"` to verify the Kaboom extension is connected and the daemon is running. If this fails, stop and tell the user to check their extension connection.
