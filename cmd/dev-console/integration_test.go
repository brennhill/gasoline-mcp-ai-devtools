...
func TestIntegration_AllMCPToolsReturnValidResponses(t *testing.T) {
	...
	toolTests := []struct {
		...
		{"observe api", `{"jsonrpc":"2.0","id":23,"method":"tools/call","params":{"name":"observe","arguments":{"what":"api"}}}`},
		{"observe accessibility", `{"jsonrpc":"2.0","id":24,"method":"tools/call","params":{"name":"observe","arguments":{"what":"accessibility"}}}`},
		{"observe changes", `{"jsonrpc":"2.0","id":25,"method":"tools/call","params":{"name":"observe","arguments":{"what":"changes"}}}`},
		{"observe timeline", `{"jsonrpc":"2.0","id":26,"method":"tools/call","params":{"name":"observe","arguments":{"what":"timeline"}}}`},
