...
// Design: Stateless analyzer operating on NetworkBody data. Risk classification
...
func (a *ThirdPartyAuditor) Audit(bodies []NetworkBody, pageURLs []string, params ThirdPartyParams) ThirdPartyResult {
...
func buildThirdPartyEntry(origin string, bodies []NetworkBody, urls []string, customLists *CustomLists) ThirdPartyEntry {
...
func HandleAuditThirdParties(params json.RawMessage, bodies []NetworkBody, pageURLs []string) (interface{}, error) {
