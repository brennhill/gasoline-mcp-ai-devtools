...
**macOS / Linux:**
```bash
curl -sSL https://raw.githubusercontent.com/nicepkg/gasoline/STABLE/scripts/install.sh | bash
```

**Windows (PowerShell):**
```powershell
irm https://raw.githubusercontent.com/nicepkg/gasoline/STABLE/scripts/install.ps1 | iex
```
