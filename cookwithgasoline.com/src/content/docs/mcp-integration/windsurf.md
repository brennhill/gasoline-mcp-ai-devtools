...
STRUM is an open-source MCP server that gives Windsurf's AI access to browser console logs, network errors, exceptions, WebSocket events, and live DOM state. Zero dependencies.
