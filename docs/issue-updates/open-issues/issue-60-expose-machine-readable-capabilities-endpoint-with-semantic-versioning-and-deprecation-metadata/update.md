# Product Update: Issue #60

## Source
- Issue: https://github.com/brennhill/gasoline-mcp-ai-devtools/issues/60
- Title: Expose machine-readable capabilities endpoint with semantic versioning and deprecation metadata
- Last Updated: 2026-02-16T13:19:38Z

## Change Summary
This update resolves or advances Issue #60 by defining a complete product behavior change, scoped to what users and AI agents should experience at runtime. The change is written to align with existing Gasoline workflows rather than introducing isolated behavior.
...
## Scope
- In scope: behavior needed to make Issue #60 functionally complete for end users.
