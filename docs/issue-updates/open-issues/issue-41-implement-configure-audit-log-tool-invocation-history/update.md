...
## Change Summary
This update resolves or advances Issue #41 by defining a complete product behavior change, scoped to what users and AI agents should experience at runtime. The change is written to align with existing Gasoline workflows rather than introducing isolated behavior.

## Problem Statement
Implement configure(audit_log) — tool invocation history
...
## Scope
- In scope: behavior needed to make Issue #41 functionally complete for end users.
