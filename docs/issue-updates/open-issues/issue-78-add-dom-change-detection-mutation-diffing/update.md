# Product Update: Issue #78

## Source
- Issue: https://github.com/brennhill/gasoline-mcp-ai-devtools/issues/78
- Title: Add DOM change detection / mutation diffing
- Last Updated: 2026-02-16T17:42:09Z

## Change Summary
This update resolves or advances Issue #78 by defining a complete product behavior change, scoped to what users and AI agents should experience at runtime. The change is written to align with existing Gasoline workflows rather than introducing isolated behavior.

## Problem Statement
Add DOM change detection / mutation diffing
...
## Scope
- In scope: behavior needed to make Issue #78 functionally complete for end users.
