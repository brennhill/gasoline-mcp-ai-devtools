...
- Last Updated: 2026-02-16T13:43:38Z

## Change Summary
This update resolves or advances Issue #64 by defining a complete product behavior change, scoped to what users and AI agents should experience at runtime. The change is written to align with existing Gasoline workflows rather than introducing isolated behavior.

## Problem Statement
Add structured page reading (readability/markdown extraction)
...
## Scope
- In scope: behavior needed to make Issue #64 functionally complete for end users.
