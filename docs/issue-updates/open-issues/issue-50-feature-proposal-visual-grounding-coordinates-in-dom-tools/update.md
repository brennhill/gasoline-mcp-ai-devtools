...
## Source
- Issue: https://github.com/brennhill/kaboom-agentic-browser-devtools-mcp/issues/50
- Title: [Feature Proposal] Visual Grounding (Coordinates) in DOM Tools
- Last Updated: 2026-02-16T13:17:06Z

## Change Summary
This update resolves or advances Issue #50 by defining a complete product behavior change, scoped to what users and AI agents should experience at runtime. The change is written to align with existing Kaboom workflows rather than introducing isolated behavior.

## Problem Statement
[Feature Proposal] Visual Grounding (Coordinates) in DOM Tools
...
## Scope
- In scope: behavior needed to make Issue #50 functionally complete for end users.
