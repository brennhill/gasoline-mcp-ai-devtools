...
## Change Summary
This update resolves or advances Issue #40 by defining a complete product behavior change, scoped to what users and AI agents should experience at runtime. The change is written to align with existing Gasoline workflows rather than introducing isolated behavior.

## Problem Statement
Test 15.17: Stage 4 fails with --upload-dir not set
...
## Scope
- In scope: behavior needed to make Issue #40 functionally complete for end users.
