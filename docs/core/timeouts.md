...
All timeouts in the Strum stack, organized by layer. Understanding the timeout hierarchy is critical — an outer timeout shorter than an inner wait causes EOF/connection-reset errors.
