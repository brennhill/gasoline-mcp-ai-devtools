---
title: Debugging AI-Generated Code with Strum
date: 2026-02-11
author: Brenn Hill
tags: [AI, Debugging, Tutorial, MCP]
description: A practical guide to using Strum to debug code generated by AI assistants like Claude Code, Cursor, and Windsurf.
status: reference
last_reviewed: 2026-02-16
---

# Debugging AI-Generated Code with Strum
...
Strum solves this by giving your AI assistant real-time visibility into browser activity. Let's walk through a practical example.
...
## With Strum: One-Shot Debugging

With Strum installed, Claude can see everything happening in the browser in real-time.
...
Claude (with Strum): "Let me check what's happening in the browser..."

[Claude uses Strum tools]
...
Here's what Strum showed Claude:
...
Download the CRX file from [usestrum.dev/downloads](https://usestrum.dev/downloads/)
