...
| Accessibility Audit | shipped | observe, generate | accessibility, sarif | 5.0.0 | [feature/sarif-export](feature/sarif-export/) |
...
| API Schema Inference | shipped | observe | api | 5.0.0 | [feature/api-schema](feature/api-schema/) |
| Behavioral Baselines | in-progress | observe | performance | — | [feature/behavioral-baselines](feature/behavioral-baselines/) |
...
| Causal Diffing | in-progress | observe, generate | changes | — | [feature/causal-diffing](feature/causal-diffing/) |
| Compressed Diffs | shipped | observe | changes | 5.0.0 | [feature/compressed-diffs](feature/compressed-diffs/) |
...
| HAR Export | shipped | generate | har | 5.0.0 | [feature/har-export](feature/har-export/) |
...
| Noise Filtering | shipped | configure | noise_rule, dismiss | 5.0.0 | [feature/noise-filtering](feature/noise-filtering/) |
| Performance Budget | shipped | configure, observe | health, performance | 5.0.0 | [feature/performance-budget](feature/performance-budget/) |
...
| Self-Testing | in-progress | interact, generate | execute_js, test | — | [feature/self-testing](feature/self-testing/) |
| SPA Route Measurement | in-progress | observe | performance, timeline | — | [feature/spa-route-measurement](feature/spa-route-measurement/) |
| Temporal Graph | shipped | observe, configure | history, record_event | 5.0.0 | [feature/temporal-graph](feature/temporal-graph/) |
...
|------|--------------|-------------|
| **observe** | errors, logs, extension_logs, network_waterfall, network_bodies, websocket_events, websocket_status, actions, vitals, page, tabs, pilot, performance, api, accessibility, changes, timeline, error_clusters, history, security_audit, third_party_audit, security_diff, command_result, pending_commands, failed_commands | Read browser telemetry |
| **generate** | reproduction, test, pr_summary, sarif, har, csp, sri | Produce artifacts from captured data |
| **configure** | store, load, noise_rule, dismiss, clear, capture, record_event, query_dom, diff_sessions, validate_api, audit_log, health, streaming | Modify server/extension settings |
| **interact** | highlight, save_state, load_state, list_states, delete_state, execute_js, navigate, refresh, back, forward, new_tab | Browser automation |
