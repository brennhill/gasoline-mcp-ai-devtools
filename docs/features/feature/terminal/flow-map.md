...
Latest sync update (2026-03-22): the terminal side panel is now specified as a tab-group-backed STRUM workspace; power closes the panel and session, minimize hides the panel but preserves the session.
