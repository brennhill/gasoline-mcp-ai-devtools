...
relates-to: [PRODUCT_SPEC.md, FEATURE_TRACKING.md, QA_PLAN.md]
...
See [QA_PLAN.md](QA_PLAN.md) for detailed test scenarios.
...
- **FEATURE_TRACKING.md** — Phase breakdown and deliverables
- **QA_PLAN.md** — Test scenarios
