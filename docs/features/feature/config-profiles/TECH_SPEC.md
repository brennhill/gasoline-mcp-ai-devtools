> **[MIGRATION NOTICE]**
> Canonical location for this tech spec. Migrated from `/docs/ai-first/tech-spec-config-profiles.md` on 2026-01-26.
> See also: [Product Spec](PRODUCT_SPEC.md) and [Config Profiles Review](config-profiles-review.md).
