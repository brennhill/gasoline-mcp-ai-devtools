...
**Target Version**: v7.0
**Based On**: [docs/features/feature/analyze-tool/TECH_SPEC.md](docs/features/feature/analyze-tool/TECH_SPEC.md)
...
**Key Design Principles** (from TECH_SPEC.md):
...
3. **If implementing**:
   - Follow [docs/features/feature/analyze-tool/TECH_SPEC.md](docs/features/feature/analyze-tool/TECH_SPEC.md) exactly
