...
Gasoline v5.0.0 marks the initial public release of the BlazeTorch protocol and extension. This release includes core browser observability features for AI coding assistants.
