...
This project is indexed by GitNexus as **gasoline** (16927 symbols, 20322 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
