...
STDOUT_ALLOWLIST="mcp_stdout.go|connect_mode.go|bridge_io_isolation|cli\.go|cli_output\.go|config\.go|main\.go|main_connection\.go|main_connection_stop(_.*)?\.go|main_helpers\.go|doctor(_.*)?\.go"
