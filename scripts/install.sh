...
echo -e "⚙️  Running native auto-configuration..."
"$GASOLINE_BIN" --install

# 8. User Guidance: Provide clear, actionable instructions for final manual steps.
echo -e "\n${GREEN}${BOLD}✅ Done! Gasoline is ready.${NC}"
echo -e "${BLUE}--------------------------------------------------${NC}"
echo -e "${YELLOW}${BOLD}1. INSTALL YOUR EXTENSION AT:${NC}"
echo -e "   ${BOLD}$EXT_DIR${NC}"
echo -e "   (Open chrome://extensions -> Developer mode -> Load unpacked)"
echo ""
echo -e "${YELLOW}${BOLD}2. RESTART YOUR AI TOOL:${NC}"
echo -e "   Claude Code, Cursor, Windsurf, etc. will now use Gasoline automatically."
echo -e "${BLUE}--------------------------------------------------${NC}"
