...
# 7. Final User Guidance: Provide clear instructions for manual browser extension loading.
Write-Host ""
Write-Host "✅ Done! Gasoline is ready." -ForegroundColor Green
Write-Host "--------------------------------------------------" -ForegroundColor Cyan
Write-Host "1. INSTALL YOUR EXTENSION AT:" -ForegroundColor Yellow
Write-Host "   $EXT_DIR" -ForegroundColor White
Write-Host "   (Open chrome://extensions -> Developer mode -> Load unpacked)"
Write-Host ""
Write-Host "2. RESTART YOUR AI TOOL:" -ForegroundColor Yellow
Write-Host "   Claude Code, Cursor, Windsurf, etc. will now use Gasoline automatically."
Write-Host "--------------------------------------------------" -ForegroundColor Cyan
