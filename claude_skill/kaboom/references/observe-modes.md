...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"errors","scope":"current_page"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"logs","min_level":"warn"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"extension_logs"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"network_waterfall","url":"https://example.com"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"network_bodies","method":"POST","status_min":400}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"websocket_events","direction":"incoming"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"websocket_status"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"actions","last_n":10}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"vitals"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"history"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"pilot"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"timeline","include":["network","console"]}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"screenshot","format":"png","full_page":true}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"storage","storage_type":"local","key":"auth_token"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"indexeddb","database":"myDB","store":"users"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"command_result","correlation_id":"abc-123"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"pending_commands"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"failed_commands"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"saved_videos"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"recordings"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"recording_actions","recording_id":"rec-001"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"playback_results","recording_id":"rec-001"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"log_diff_report","original_id":"rec-001","replay_id":"rec-002"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"summarized_logs","min_group_size":3}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"page_inventory","visible_only":true}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"transients","classification":"toast"}'
```
...
**Example:**
```bash
bash scripts/kaboom-call.sh observe '{"what":"inbox"}'
```
