...
bash scripts/kaboom-call.sh interact '{"what":"navigate","url":"<page_url>","wait_for_stable":true,"analyze":true}'
...
bash scripts/kaboom-call.sh observe '{"what":"timeline"}'

# Performance analysis
bash scripts/kaboom-call.sh analyze '{"what":"performance"}'

# Save baseline snapshot
bash scripts/kaboom-call.sh configure '{"what":"diff_sessions","verif_session_action":"capture","name":"perf_baseline"}'
```
...
bash scripts/kaboom-call.sh interact '{"what":"click","selector":"<cta>","analyze":true,"wait_for_stable":true}'
...
bash scripts/kaboom-call.sh configure '{"what":"diff_sessions","verif_session_action":"capture","name":"perf_candidate"}'
```
...
```bash
# Session comparison
bash scripts/kaboom-call.sh configure '{"what":"diff_sessions","verif_session_action":"compare","compare_a":"perf_baseline","compare_b":"perf_candidate"}'

# Network body comparison for API response times
bash scripts/kaboom-call.sh observe '{"what":"network_bodies","summary":true}'
