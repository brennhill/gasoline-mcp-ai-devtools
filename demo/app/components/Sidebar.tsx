  ...
  return (
    <aside className="w-64 bg-slate-900 border-r border-slate-700 flex flex-col">
      <div className="p-6 border-b border-slate-700">
        <h1 className="text-xl font-bold text-white">What SaaS?</h1>
        <p className="text-sm text-slate-400 mt-1">We do things, we promise.</p>
      </div>
      ...
      <div className="p-4 border-t border-slate-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm text-white">Demo User</p>
            <p className="text-xs text-slate-400">demo@whatsaas.io</p>
          </div>
        </div>
      </div>
    </aside>
