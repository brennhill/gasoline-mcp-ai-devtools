...
[![Version](https://img.shields.io/badge/version-0.7.1-green.svg)](https://github.com/brennhill/gasoline-mcp-ai-devtools/releases)
...
Current version: **v0.7.1** — Link health analyzer, browser automation, recording, and performance analysis for AI agents.

```bash
npx gasoline-mcp@0.7.1
```
...
# Should return: {"status":"ok","version":"0.7.1",...}
```
...
Last benchmarked: 2026-02-09 on darwin/arm64 (v0.7.1)
