...
[![Version](https://img.shields.io/badge/version-6.1.7-green.svg)](https://github.com/brennhill/gasoline-mcp-ai-devtools/releases)
...
Current version: **v6.1.7** — Link health analyzer, browser automation, recording, and performance analysis for AI agents.

```bash
npx gasoline-mcp@6.1.7
```
...
# Should return: {"status":"ok","version":"6.1.7",...}
```
...
Last benchmarked: 2026-02-09 on darwin/arm64 (v6.1.7)
