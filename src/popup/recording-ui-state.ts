...
// #lizard forgives
export function showRecording(els: RecordingElements, state: RecordingState, name: string, startTime: number): void {
...
export function showIdle(els: RecordingElements, state: RecordingState): void {
...
export function describePendingRecording(pending: PendingRecordingIntent): string {
  const parts: string[] = []
...
export function setApprovalPendingState(
...
export function showTopNotice(els: RecordingElements, text: string): void {
...
export function showSavedLink(saveInfoEl: HTMLElement, displayName: string, filePath: string): void {
...
export function showStartError(saveInfoEl: HTMLElement | null, errorText: string): void {
