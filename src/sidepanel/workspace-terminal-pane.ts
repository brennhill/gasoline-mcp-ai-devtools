...
function createTerminalHeader(options: CreateWorkspaceTerminalPaneOptions): {
...
export function createWorkspaceTerminalPane(
  options: CreateWorkspaceTerminalPaneOptions
): WorkspaceTerminalPaneElements {
