...
// =============================================================================
// INJECT QUERY REGISTRY — single dispatch for all inject-bridged queries
// =============================================================================

interface InjectQueryEntry {
  queryType: string
  responseType: string
  label: string
}

const INJECT_QUERY_REGISTRY: Record<string, InjectQueryEntry> = {
  computed_styles: {
