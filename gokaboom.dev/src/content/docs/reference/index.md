...
description: Readthedocs-style entry point for KaBOOM MCP tool APIs, request shapes, and common usage patterns.
...
These parameters appear repeatedly across KaBOOM tools:
...
- HTML: `https://gokaboom.dev/guides/debug-webapps/`
- Markdown: `https://gokaboom.dev/guides/debug-webapps.md`
